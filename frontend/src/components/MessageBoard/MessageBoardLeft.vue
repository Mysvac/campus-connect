...
<script>
export default {
  name: 'MessageBoardLeft',
  data() {
    return {
      tags: [
        { id: 1, name: '全部', active: true },
        { id: 2, name: '学习', active: false },
        { id: 3, name: '生活', active: false },
        { id: 4, name: '活动', active: false },
        { id: 5, name: '失物', active: false },
        { id: 6, name: '交易', active: false },
        { id: 7, name: '求助', active: false },
        { id: 8, name: '吐槽', active: false }
      ]
    }
  },
  methods: {
