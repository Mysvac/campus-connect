...
<script>
export default {
  name: 'RatingLeftAside',  data() {
    return {
      tags: [
        { id: 0, name: '全部', active: true },
        { id: 1, name: '课程教学', active: false },
        { id: 2, name: '学习场所', active: false },
        { id: 3, name: '餐饮美食', active: false },
        { id: 4, name: '住宿条件', active: false },
        { id: 5, name: '运动健身', active: false },
        { id: 6, name: '校园服务', active: false },
        { id: 7, name: '校园活动', active: false }
      ]
    }
  },  methods: {
    selectTag(tagId) {
